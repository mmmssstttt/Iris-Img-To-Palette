...
def extract_top10_chroma_saliency_oklab(
    ...
    # Stronger chroma contributes more attention weight.
    ...
    mean_chroma = np.bincount(labels, weights=chroma, minlength=k) / np.maximum(
    ...
    top_colors = [
        _center_to_record(
            ...
            mean_chroma=float(mean_chroma[idx]),
        )
    ...
    return {
        ...
        "description": "Use Oklab chroma (C) as saliency gain for vivid color weighting.",
